...
You can also browse the content as [hypertext here in English (en)](en/01_introduction/01_jdd_briefly.md). You can also download the book and build an EPUB or self-contained HTML (again using Pandoc).
